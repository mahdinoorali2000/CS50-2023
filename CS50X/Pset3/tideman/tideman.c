...
{
    // TODO
    for (int a = pair_count; a > 0; a--)
    {
        for (int b = 0; b < a - 1; b++)
        {
            int x = preferences[pairs[b].winner][pairs[b].loser] - preferences[pairs[b].loser][pairs[b].winner];
            int z = preferences[pairs[b + 1].winner][pairs[b + 1].loser] - preferences[pairs[b + 1].loser][pairs[b + 1].winner];
            if (x < z)
            {
                pair temp = pairs[b + 1];
                pairs[b + 1] = pairs[b];
...
void lock_pairs(void)
{
    ...
    {
        if (!cycle(pairs[a].loser, pairs[a].winner))
        {
